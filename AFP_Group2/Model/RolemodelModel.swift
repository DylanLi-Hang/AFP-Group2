...
class RolemodelModel {
    ...
    var factsAbout : [QuoteModel]?
    var introduction : String
    
    init(name: String, img: UIImage? = nil, careerIntro: String, factsAbout: [QuoteModel]? = nil, introduction: String) {
        self.name = name
        self.img = img
...
extension RolemodelModel {
    static let roleModelDummyData = [
        RolemodelModel(
            ...
            factsAbout: QuoteModel.quotesDummyData,
