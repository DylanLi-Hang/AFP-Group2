...
//  AFP_Group2
//
//  Created by Fabian Roth on 21/11/2023.
//
...
//    private var people = ["peter", "person", "pan", "hustler", "pabian", "someone"]
...
//                                    scrollToCenterY(scrollViewProxy: geometry, id: index)
//                                }
//                            VStack {
...
//        }
//    }
//    func scrollToCenterY(scrollViewProxy: ScrollViewProxy, id: Int) {
//            withAnimation {
...
//
//#Preview {
//    TestView(stateManager: StateManager())
//}
//
//
//
